...
def async_measure_time(func):
    """
    Определяет то за какое время исполнится асинхронная функция от ее стартовой позиции до окончания
    :param func:
    :return:
    """
...
def measure_time(func):
    """
    Определяет то за какое время исполнится функция от ее стартовой позиции до окончания
    :param func:
    :return:
    """
    @wraps(func)
